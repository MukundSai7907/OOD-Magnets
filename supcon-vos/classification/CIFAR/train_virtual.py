...
def train(epoch):
    ...
    for data, target in train_loader:
        ...
        if sum_temp == num_classes * args.sample_number and epoch < args.start_epoch:
            ...
            if len(ood_samples) != 0:
                ...
                predictions_ood = net.modelB(ood_samples)
        ...
        #Just for printing
        uncertainty_loss_only += lr_reg_loss.item()
    ...
    print('Epoch: ', epoch)
    print('uncertainty_loss_only: ', uncertainty_loss_only)
    print('CE_loss_only: ', CE_loss_only)
