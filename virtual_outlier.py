...
# Checkpoints
parser.add_argument('--save', '-s', type=str, default='./save', help='Folder to save checkpoints.')
...
if args.dataset == 'cifar10':
    train_data = dset.CIFAR10('./datasets/', train=True, transform=train_transform, download=True)
    test_data = dset.CIFAR10('./datasets/', train=False, transform=test_transform, download=True)
    num_classes = 10
else:
...
if args.model == 'supcon':
    ...
    net = SupConResNet(name=args.model_name)
...
if args.load != '':
    for i in range(1000 - 1, -1, -1):
        ...
        if os.path.isfile(model_name):
            ...
            #@TODO :: check logic of why start_epoch is based on this loop var
            start_epoch = 100
            break
    if start_epoch == 0:
...
args.save = args.save + "/{}_baseline".format(args.dataset)
# Make save directory
